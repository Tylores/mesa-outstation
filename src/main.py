...
stdout_stream.setFormatter(logging.Formatter(
...
class OutstationApplication(opendnp3.IOutstationApplication):
    ...
    def __init__(self):
        ...
        self.manager = asiodnp3.DNP3Manager(
            threads_to_allocate, self.log_handler)
    ...
    def apply_update(self, value, index):
        ...
        """
        _log.debug('Recording {} measurement, index={}, value={}'.format(
...
class MyLogger(openpal.ILogHandler):
    ...
    def Log(self, entry):
        ...
        _log.debug('Log\tfilters={}\tlocation={}\tentry={}'.format(
            filters, location, message))
